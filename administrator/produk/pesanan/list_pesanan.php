...
?>
<?php 
   $sql = "SELECT pesanan.*, motor.nama_motor FROM pesanan INNER JOIN motor ON pesanan.motor_id=motor.id";
   $rs = $dbh->query($sql);
?>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="../motor/list_motor.php">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Database Pesanan</h1>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    onclick="if(!confirm('Anda Yakin Hapus Data pesanan <?=$row['nama_pelanggan']?> ?')) 
